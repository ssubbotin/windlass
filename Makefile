...
BINARIES = infer_glm test_glm_chain test_glm_layer test_glm_expert_cache test_glm_mxfp4 test_glm_indexer_loader
...
test_glm_mxfp4: $(SRC)/test_glm_mxfp4.cu $(SRC)/glm_kernels.cuh
	$(NVCC) $(CFLAGS) -I$(SRC) -o $@ $< $(LDFLAGS)
